...
class LoadVideoFromPatch(object):
    ...
    def __call__(self, results):
        ...
        filenames = filenames[patch[0]: patch[1]: interval]
        filenames = [os.path.join(filename, img) for img in filenames]
...
@registry.register_module('pipeline')
class LoadVideoFromRepo(object):
    """Load an image from file.
