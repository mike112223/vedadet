...
@registry.register_module('pipeline')
class VideoMultiScaleFlipAug(object):
    """Test-time augmentation with multiple scales and flipping.
    ...
    def __init__(self,
        ...
        assert (window_size is not None), (
            'Must have but only one variable can be setted')
        self.window_size = window_size if isinstance(window_size,
                                                     list) else [window_size]
        self.scale_key = 'window_size'
    ...
    def __repr__(self):
        repr_str = self.__class__.__name__
        repr_str += f'(transforms={self.transforms}, '
        repr_str += f'window_size={self.window_size}, flip={self.flip})'
        repr_str += f'flip_direction={self.flip_direction}'
        return repr_str
