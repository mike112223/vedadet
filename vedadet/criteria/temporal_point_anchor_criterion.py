...
class TemporalPointAnchorCriterion(BaseCriterion):
    ...
    def get_targets(self, points, gt_labels_list, gt_bboxes_list):
        ...
        expanded_regress_ranges = [
            points[i].new_tensor(self.regress_ranges[i])[None].expand(
                [points[i].size()[0], 2]) for i in range(num_levels)
        ]
    ...
    def _get_target_single(self, gt_bboxes, gt_labels, points, regress_ranges,
        ...
        areas[inside_gt_bbox_mask == 0] = TemporalPointAnchorCriterion.INF
        areas[inside_regress_range == 0] = TemporalPointAnchorCriterion.INF
        min_area, min_area_inds = areas.min(dim=1)

        labels = gt_labels[min_area_inds]
        labels[min_area ==
               TemporalPointAnchorCriterion.INF] = self.background_label  # set as BG
