...
# 6. checkpoint
weights = dict(
    filepath='workdir/baseline_ssd_randomcrop_sgdr_fps25_flip_nohnbn/epoch_100_weights.pth')
optimizer = dict(filepath='workdir/baseline_ssd_randomcrop_sgdr_fps25_flip_nohnbn/epoch_100_optim.pth')
meta = dict(filepath='workdir/baseline_ssd_randomcrop_sgdr_fps25_flip_nohnbn/epoch_100_meta.pth')
