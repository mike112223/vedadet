    ...
    train=dict(
        ...
        pipeline=[
            ...
            dict(typename='LoadVideoFromPatch',
                 to_float32=True),
            dict(
                typename='PhotoMetricDistortion3D',
                brightness_delta=32,
...
#weights = dict(
#    filepath='workdir/baseline_ssd_randomcrop_sgdr_fps25_flip_rot10/epoch_50_weights.pth')
#optimizer = dict(filepath='workdir/baseline_ssd_randomcrop_sgdr_fps25_flip_rot10/epoch_50_optim.pth')
#meta = dict(filepath='workdir/baseline_ssd_randomcrop_sgdr_fps25_flip_rot10/epoch_50_meta.pth')
