...
# 6. checkpoint
weights = dict(
   filepath='workdir/baseline_ssd_randomcrop_sgdr_fps25_flip_rot10_anchor7/epoch_600_weights.pth')
optimizer = dict(filepath='workdir/baseline_ssd_randomcrop_sgdr_fps25_flip_rot10_anchor7/epoch_600_optim.pth')
meta = dict(filepath='workdir/baseline_ssd_randomcrop_sgdr_fps25_flip_rot10_anchor7/epoch_600_meta.pth')
