...
train_engine = dict(
    ...
    model=model,
    criterion=dict(
        typename='AnaTemporalBBoxAnchorCriterion',
        num_classes=num_classes,
        meshgrid=meshgrid,
...
# 6. checkpoint
weights = dict(
    filepath='workdir/baseline_ssd_fullopen_600e_lr6e-4/epoch_300_weights.pth')
optimizer = dict(filepath='workdir/baseline_ssd_fullopen_600e_lr6e-4/epoch_300_optim.pth')
meta = dict(filepath='workdir/baseline_ssd_fullopen_600e_lr6e-4/epoch_300_meta.pth')
