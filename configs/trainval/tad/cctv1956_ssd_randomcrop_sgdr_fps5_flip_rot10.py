...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'cctv_train_1956_anno.json',
        img_prefix=data_root + 'data/extracted_imgs/images_5fps_resize_180_240',
        fps=fps,
        pipeline=[
            dict(
    ...
    val=dict(
        typename=dataset_type,
        ann_file=data_root + 'cctv_val_anno.json',
        img_prefix=data_root + 'data/extracted_imgs/images_5fps_resize_180_240',
        fps=fps,
        pipeline=[
...
# 6. checkpoint
weights = dict(
    filepath='workdir/cctv1956_ssd_randomcrop_sgdr_fps5_flip_rot10/epoch_140_weights.pth')
optimizer = dict(filepath='workdir/cctv1956_ssd_randomcrop_sgdr_fps5_flip_rot10//epoch_140_optim.pth')
meta = dict(filepath='workdir/cctv1956_ssd_randomcrop_sgdr_fps5_flip_rot10//epoch_140_meta.pth')
