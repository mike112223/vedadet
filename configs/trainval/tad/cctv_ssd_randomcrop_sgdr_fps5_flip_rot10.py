...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'cctv_train_938_anno.json',
...
# 6. checkpoint
weights = dict(
    filepath='workdir/cctv_ssd_randomcrop_sgdr_fps5_flip_rot10/epoch_60_weights.pth')
optimizer = dict(filepath='workdir/cctv_ssd_randomcrop_sgdr_fps5_flip_rot10/epoch_60_optim.pth')
meta = dict(filepath='workdir/cctv_ssd_randomcrop_sgdr_fps5_flip_rot10/epoch_60_meta.pth')
