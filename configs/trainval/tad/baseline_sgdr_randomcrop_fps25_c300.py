...
# 6. checkpoint
weights = dict(
    filepath='workdir/baseline_sgdr_randomcrop_fps25/epoch_300_weights.pth')
optimizer = dict(filepath='workdir/baseline_sgdr_randomcrop_fps25/epoch_300_optim.pth')
meta = dict(filepath='workdir/baseline_sgdr_randomcrop_fps25/epoch_300_meta.pth')
