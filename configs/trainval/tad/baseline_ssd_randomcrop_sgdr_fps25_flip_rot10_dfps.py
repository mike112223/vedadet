...
# 6. checkpoint
weights = dict(
    filepath='workdir/baseline_ssd_randomcrop_sgdr_fps25_flip_rot10_dfps/epoch_550_weights.pth')
optimizer = dict(filepath='workdir/baseline_ssd_randomcrop_sgdr_fps25_flip_rot10_dfps/epoch_550_optim.pth')
meta = dict(filepath='workdir/baseline_ssd_randomcrop_sgdr_fps25_flip_rot10_dfps/epoch_550_meta.pth')
...
workdir = '/DATA_DB25/sdc/data/yanjiazhu/code/vedadet_workdir/baseline_ssd_randomcrop_sgdr_fps25_flip_rot10_dfps'
